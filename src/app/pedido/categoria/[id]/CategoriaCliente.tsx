 ...
 *
 * Fica separado do page.tsx porque `generateStaticParams` não pode ser
 * exportado de um arquivo 'use client' — e sem ele o build do Electron
 * (output: 'export') recusa esta rota.
 */
